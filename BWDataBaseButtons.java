/*Data Base Buttons Class Black and White / Dark Mode Version
This is the class that has codes of the buttons in the customer database */
import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class BWDataBaseButtons implements ActionListener
{
    //buttons declaration
    ...
    public BWDataBaseButtons (JPanel panel, String title0, String title1, String title2, String title3, String title4, String title5)
    { //comstructor
	...
	{
	    panel.add (feature [i]);
	    feature [i].setForeground (Color.white);
	}

	feature [5].setForeground (Color.black);
	JLabel title = new JLabel ();
	ImageIcon img = new ImageIcon ("Customer Database BW.jpg");
	title.setIcon (img);
	panel.add (title);
	...
	Color fc = new Color (226, 226, 226);
	...
	displayIcon = new ImageIcon ("magnifyBW.jpg");
	feature [1].setIcon (displayIcon);
	displayIcon = new ImageIcon ("levelsBW.jpg");
	feature [2].setIcon (displayIcon);
	displayIcon = new ImageIcon ("plusBW.jpg");
	feature [3].setIcon (displayIcon);
	displayIcon = new ImageIcon ("minusBW.jpg");
	...
	{ //SORT
	    ...
	    Color fc = new Color (104, 103, 103);
	    Font f = new Font ("Sigmar One ", Font.BOLD, 36);
	    //set images to buttons

	    ImageIcon pic = new ImageIcon ("babyBW.jpg");
	    addOnFt [6].setIcon (pic);
	    pic = new ImageIcon ("adultBW.jpg");
	    addOnFt [7].setIcon (pic);
	    pic = new ImageIcon ("oldBW.jpg");
	    addOnFt [8].setIcon (pic);
	    pic = new ImageIcon ("ageBW.jpg");
	    addOnFt [1].setIcon (pic);
	    pic = new ImageIcon ("moneyBW.jpg");
	    addOnFt [0].setIcon (pic);
	    pic = new ImageIcon ("pointsBW.jpg");
	    addOnFt [9].setIcon (pic);
	    pic = new ImageIcon ("bronzeBW.jpg");
	    addOnFt [12].setIcon (pic);
	    pic = new ImageIcon ("silverBW.jpg");
	    addOnFt [13].setIcon (pic);
	    pic = new ImageIcon ("goldBW.jpg");
		...
		addOnFt [i].setForeground (Color.white);
		x += 75;
	    }
	    addOnFt [9].setBounds (70, 375, 180, 50);
	    addOnFt [9].setBackground (fc);
	    addOnFt [9].setForeground (Color.white);
	...
	{ //search
	    ...
	    { //error trap if they dont put anything for first name
	    ...
	    { //error trap if they dont put anything for last name
	...
	{ //errror trap if user is not found
